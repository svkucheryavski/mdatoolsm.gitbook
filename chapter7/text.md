...
3. Make predictions. If a predicted response value is above or equal to 0, the corresponding object is considered to be a member of the class, if not, the object is rejected as not the class member.
